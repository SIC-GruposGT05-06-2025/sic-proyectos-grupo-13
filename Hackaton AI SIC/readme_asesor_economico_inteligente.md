...
- 💬 Chat explicativo del riesgo

---

## 🤖 Chat explicativo inteligente

La aplicación incluye un **chatbox** que permite:
- Preguntar por qué un cliente tiene cierto nivel de riesgo
- Obtener explicaciones en lenguaje natural
- Justificar decisiones ante equipos directivos

Ejemplo:
> *"Este cliente tiene riesgo alto debido a contrato mensual y cargos elevados"*
...
├── resultado_riesgo_alto.png
├── impacto_economico.png
├── chat_explicativo.png
```
...
![Resultado de riesgo](screenshots/resultado_riesgo_alto.png)
![Chat explicativo](screenshots/chat_explicativo.png)
```

---

## 🌟 Valor agregado para los jueces
